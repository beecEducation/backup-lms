...
export const createFreePackage = /* GraphQL */ `
  mutation CreateFreePackage($packageId: ID!, $userId: ID!, $quizId: ID!) {
    createFreePackage(packageId: $packageId, userId: $userId, quizId: $quizId)
  }
`;
...
export const addUserFromSignup = /* GraphQL */ `
  mutation AddUser(
    $input: AddUserInput!
    $parent: AddParentInput
    $mode: UserType
  ) {
    addUser(input: $input, parent: $parent, mode: $mode)
  }
`;
...
export const signup = /* GraphQL */ `
  mutation Signup(
    ...
    signup(mode: $mode, email: $email, input: $input, parent: $parent)
  }
`;
...
export const updateUserQuizSection = /* GraphQL */ `
  mutation UpdateUserQuizSection(
    $id: ID!
    $quizId: ID!
    $userQuizId: ID!
    $userId: ID!
...
export const updateProfile = /* GraphQL */ `
  mutation UpdateProfile($input: UpdateProfileInput!, $userType: UserType!) {
    updateProfile(input: $input, userType: $userType)
  }
`;
